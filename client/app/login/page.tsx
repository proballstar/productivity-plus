        ...
        <div className="flex min-h-screen flex-col bg-[#BACAE3] w-screen">
            ...
            <div className='items-center justify-center flex flex-col space-y-6'>
                ...
                <div className="bg-gray-200 text-sm text-gray-500 leading-none border-2 border-gray-200 rounded-full inline-flex">
                    <button onClick={() => setCurPage("Login")} className="inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:text-blue-400 focus:text-blue-400 rounded-l-full px-4 py-2 active" id="grid">
                        <span>Login</span>
                    </button>
                    <button onClick={() => setCurPage("Register")} className="inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:text-blue-400 focus:text-blue-400 rounded-r-full px-4 py-2" id="list">
                        <span>Register</span>
                    </button>
                </div>
