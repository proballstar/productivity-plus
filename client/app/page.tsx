...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#BACAE3] w-screen px-20">
      ...
      <div className="flex flex-row m-auto  gap-2">
        <div className="flex flex-col justify-center">
          <div className="text-8xl">
            ...
            <span className="text-transparent font-black bg-clip-text bg-gradient-to-r from-[#2A3757] to-[#7D9ABC]">
              Plus
            </span>
          </div>
          <p className="font-normal text-xl text-black">
            Why be productive when you just cannot be?
          </p>
        </div>
        <div>
          <Image
